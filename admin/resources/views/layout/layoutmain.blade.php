...
<body>
    <div class="main-wrapper">
        <div class="sidebar-cstm">
            ...
            <a href="/" class="sidebaratag {{ Request::is('/') ? 'activesidebaratag' : '' }}"><i class="fa-solid fa-house icontagcstm"></i><span class="sidebartexttag">Dashboard</span></a>
            <a href="/contact" class="sidebaratag {{ Request::is('contact') ? 'activesidebaratag' : '' }}"><i class="fa-solid fa-address-card icontagcstm"></i><span class="sidebartexttag">Contact</span></a>
            <a href="/event" class="sidebaratag {{ Request::is('event') ? 'activesidebaratag' : '' }}"><i class="fa-solid fa-calendar-days icontagcstm"></i><span class="sidebartexttag">Events</span></a>
            <hr class="line-cstm">
